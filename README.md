...
> Looking for a way to embed Fakify into your own product? -> [There is an API!](https://github.com/Timhongphuc/FakifyAPI)
...
### Please mind your usage. Thank you! (My API credit balance is not infinite --> 1 query ≈ 0.10$)
